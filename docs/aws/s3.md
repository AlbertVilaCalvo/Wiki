...
[Delete bucket](https://docs.aws.amazon.com/cli/latest/reference/s3api/delete-bucket.html) (must be empty)

```shell
aws s3api delete-bucket --bucket <bucket-name>
```

[Upload file](https://docs.aws.amazon.com/cli/latest/reference/s3api/put-object.html)
...
Enable bucket versioning ([docs](https://docs.aws.amazon.com/cli/latest/reference/s3api/put-bucket-versioning.html)):
...
List object versions ([docs](https://docs.aws.amazon.com/cli/latest/reference/s3api/list-object-versions.html)):
...
Restore an archived object from (eg) Glacier ([docs](https://docs.aws.amazon.com/cli/latest/reference/s3api/restore-object.html)):
...
Create bucket ([docs](https://docs.aws.amazon.com/cli/latest/reference/s3/mb.html)):

```shell
aws s3 mb s3://my-bucket-name
```

Delete bucket ([docs](https://docs.aws.amazon.com/cli/latest/reference/s3/rb.html)):
...
List buckets ([docs](https://docs.aws.amazon.com/cli/latest/reference/s3/ls.html)):

```shell
aws s3 ls
```

List files in bucket ([docs](https://docs.aws.amazon.com/cli/latest/reference/s3/ls.html)):

```shell
aws s3 ls s3://my-bucket
```

Delete all files in bucket ([docs](https://docs.aws.amazon.com/cli/latest/reference/s3/rm.html)):

```shell
aws s3 rm --recursive s3://my-bucket/
```

Upload single file to bucket ([docs](https://docs.aws.amazon.com/cli/latest/reference/s3/cp.html)):
...
Upload multiple files (a directory) to bucket ([docs](https://docs.aws.amazon.com/cli/latest/reference/s3/sync.html)):
...
Download file ([docs](https://docs.aws.amazon.com/cli/latest/reference/s3/cp.html)):

```shell
aws s3 cp s3://my-bucket/code/lambda_function.py ~/Downloads
```

Download folder ([docs](https://docs.aws.amazon.com/cli/latest/reference/s3/cp.html)):
...
You can see all the CloudFront Origin access control you have at your AWS account at the left menu of CloudFront console, at Security → Origin access. For a distribution, check its origins at the 'Origins' tab.
...
Initially you have 2 records: NS and SOA ([see Route 53](route53.md#records)). After doing all this, you'll have 6 records:

| Record name                                            | Type  | Routing | Alias | Value/Route traffic to                                                                      | TTL (seconds) |
| ------------------------------------------------------ | ----- | ------- | ----- | ------------------------------------------------------------------------------------------- | ------------- |
| recipeapp.link                                         | A     | Simple  | Yes   | d1ps7fg1ex8e20.cloudfront.net.                                                              | -             |
| www.recipeapp.link                                     | A     | Simple  | Yes   | d1ps7fg1ex8e20.cloudfront.net.                                                              | -             |
| \_f6641037beb71d9c546f5dcdf4013a96.recipeapp.link      | CNAME | Simple  | No    | \_c578550f933f1cd4370bb19046985d96.xlfgrmvvlj.acm-validations.aws.                          | 300           |
| \_6552e694c417f62732f560cod893c177.www.recipeapp.link/ | CNAME | Simple  | No    | \_33442bbf2c28e5afd54c1e99bd7c23c8.xlfgrmvvlj.acm-validations.aws.                          | 300           |
| recipeapp.link                                         | NS    | Simple  | No    | ns-703.awsdns-23.net. ns-423.awsdns-52.com. ns-1878.awsdns-42.co.uk. ns-1305.awsdns-35.org. | 172800        |
| recipeapp.link                                         | SOA   | Simple  | No    | ns-703.awsdns-23.net. awsdns-hostmaster.amazon.com. 1 7200 900 1209600 86400                | 900           |

You can also create AAAA records, [see Route 53](route53.md#records).

### Redirect www to non-www

To redirect the `www.example.com/*` request to `example.com/*` follow the [instructions at the CloudFront doc](cloudfront#redirect-www-to-non-www).
