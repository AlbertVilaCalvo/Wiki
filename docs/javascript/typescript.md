...
See the default `tsconfig.json` generated by `tsc --init` since TypeScript 5.9 at https://devblogs.microsoft.com/typescript/announcing-typescript-5-9/#minimal-and-updated-tsc---init
